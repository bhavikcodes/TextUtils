...
export default function About() {
    ...
    // let stylesD = {display:"inline"};
    // let stylesL = {display:"inline"};
    // let stylebg = {};
    // let enableDark = ()=>{
    ...
    // }
    // if(dark){
    //     stylesD = {display:"none"};
    //     stylebg = {backgroundColor:"black",color:"white"};
    // }else{
    //     stylesL = {display:"none"};
    //     stylebg = {backgroundColor:"white",color:"black"};
    // }
